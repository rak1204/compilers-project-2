    ...
    public void typeCheck(List<Type> types){
        ...
        try {
            while(it.hasNext())
            {
                ...
                {
                    ErrMsg.fatal(curr.lineNum(), curr.charNum(), "Type of actual does not match type of formal");
                }      
                i++;
            }
        } catch (Exception e) {
            System.err.println("Unexpected error in ExpList typeCheck()");
            System.exit(-1);
        }
    }
...
class ReturnStmtNode extends StmtNode {
    ...
    public void typeCheck(Type t){
        ...
        else
        {
            ...
            else if(!t.isErrorType() && !t.equals(tmp) && !tmp.isErrorType())
            {
...
class IdNode extends ExpNode {
    ...
    public Type typeCheck()
    {
        if(mySym == null)
        {
            System.err.println("id has null");
            System.exit(-1);
        }
        else
        {
...
class AssignNode extends ExpNode {
    ...
    public Type typeCheck()
    {
        ...
        if(l.isStructDefType())
        {
            if(e.isStructDefType())
            {
...
class CallExpNode extends ExpNode {
    ...
    public Type typeCheck() 
    {
        ...
        FnSym f = (FnSym)(myId.sym());
        int paramNum = f.getNumParams();

        if(paramNum == myExpList.size()){
            myExpList.typeCheck(f.getParamTypes());
...
class PlusNode extends BinaryExpNode {
    ...
    public Type typeCheck()
    {
        Type l = myExp1.typeCheck();
        Type r = myExp2.typeCheck();
